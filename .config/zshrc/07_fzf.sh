# NOTE: I started using (https://alexpasmantier.github.io/television/)
...
#
eval "$(tv init zsh)"
alias ftv='tv channels'
alias ff='nvim $(tv files)'
alias falias="tv alias"
alias fman="tv man-pages"
alias fkill="tv procs"
alias fh='tv zsh-history'
alias fcron="tv crontab"
alias fpath="tv path"
alias fcd="tv zoxide"
alias fmount="tv mounts"
alias ftodo="tv todo-comments"
alias fts="tv tmux-sessions"
alias ftw="tv tmux-windows"
alias fports="tv ports"
alias fopencode="tv opencode-sessions"
alias fpip="tv pip-packages"
alias fpyenv="tv python-venvs"
alias fsys="tv systemd-units"
alias fdisk="tv diskutil"
alias fjournal="tv journal"
alias fmake="tv make-targets"
alias fnode="tv node-packages"
alias fnpmp="tv npm-packages"
alias fnpms="tv npm-scripts"
alias fssh="tv ssh-hosts"
alias ftxt="tv text"
alias ftrash="tv trash"
alias fdot="tv dotfiles"
