...
alias sys_enable-now="sudo systemctl enable --now"
alias sys_disable="sudo systemctl disable"
alias sys_disable-now="sudo systemctl disable --now"
...
alias sys_daemon-reload="sudo systemctl daemon-reload"
alias sys_try-restart="sudo systemctl try-restart"
alias sys_show-failed="sudo systemctl --state=failed"
alias sys_reset-filad="sudo systemctl reset-failed"     ## Reset the failed state of the specified unit/s
...
alias sys_set-env="sudo systemctl set-environment"      ## Set 1/more systemd manager environment vars
alias sys_unset-env="sudo systemctl unset-environment"  ## Unset 1/more systemd manager environment vars
...
alias sys_list_unit_files="systemctl list-unit-files"   ## List unit files installed on the system
